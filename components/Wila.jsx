...
const Wila = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await getLagerDetails("wila");
  ...
  return (
    <div className="container mx-auto px-0 lg:px-10 mb-8">
      ...
      <div className='bg-white shadow-lg rounded-b-lg p-8 mb-8'>        
        <div className='relative overflow-hidden mb-6'>
          <h1 className='text-blue-800 mb-8 text-4xl lg:text-6xl font-bold'>{lagerDetails.lager.was}</h1>
            ...
            <AccordionSection title='
              ...
              ' content={
                  <div className='text-lg lg:text-xl'>
                      <p className='mb-3'>Wir werden 5 Tage in den Bergen verbringen und eine tolle Zeit (mit hoffentlich viel Schnee) verbringen. Man muss nicht Ski oder Snowboard fahren können um ins Lager zu kommen. </p>
                  </div>
               } />
            <AccordionSection title='
                  Wann?
            ...
            {lagerDetails.lagersConnection.edges.map((post) => (
                <div key={post.node.title}>
                    <div className='bg-white shadow-lg rounded-lg p-0 pb-5'>
                        ...
                        <p className='text-2xl font-bold text-blue-800 px-3'>Wila Blog {post.node.jahr}</p>
                        <br />
