  ...
  return (
    <div className="container mx-auto px-0 lg:px-10 mb-8">
      <div className='bg-white shadow-lg rounded-lg rounded-t-xl p-8 pb-8 mb-8'>
        ...
        <p className='text-lg lg:text-2xl'>Unsere Jungwacht besteht aus einem engagierten <strong>Leitungsteam</strong> und <strong>Gruppen</strong>, in denen sich gleichaltrige Kinder und Jugendliche regelmässig treffen. Gemeinsam gehen wir ins <strong>Lager</strong> und verbringen spannende <strong>Scharanlässe</strong>. </p>
