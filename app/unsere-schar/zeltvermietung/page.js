  ...
  return (
    <div className="container mx-auto px-0 lg:px-10 mb-8">
      <div className='bg-white shadow-lg rounded-lg p-8 mb-8'>
        <h1 className='text-blue-800 transition duration-700 mb-4 hover:text-blue-600 text-6xl font-bold'>Zeltvermitung</h1>
        ...
        <div className='text-2xl'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 mb-4'>
            ...
            <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScjp5DT9LqPPCXem38Pf0YF3DK6nmGjMVXmVR12P_jmsQaZYg/viewform?embedded=true" width="100%" height="100%">Loading…</iframe>        </div>
          </div>
        </div>
        <br className='mb-10' />
      <div />
