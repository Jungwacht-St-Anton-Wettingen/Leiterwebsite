  ...
  return (
    <div className="container mx-auto px-0 lg:px-10 mb-8">
      <div className='bg-white shadow-lg rounded-lg rounded-t-xl p-0 pb-8 mb-8'>
        ...
        ></iframe>
        <div className='p-8'>
            <h1 className='text-blue-800 transition duration-700 mb-1 hover:text-blue-600 text-4xl font-bold'>Das ist Jungwacht und Blauring (JuBla)</h1>
            ...
            <p className='text-lg mb-2'>Jungwacht und Blauring (Jubla) bietet Freizeitgestaltung und Ferienlager für alle Kinder und Jugendliche. Die einzelnen Vereine (genannt «Scharen») sind in der ganzen Deutschschweiz verteilt. In der Jubla sind alle willkommen.</p>
            <p className='text-lg'>
